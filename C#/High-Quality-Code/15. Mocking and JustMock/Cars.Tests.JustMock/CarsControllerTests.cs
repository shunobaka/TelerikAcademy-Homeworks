namespace Cars.Tests.JustMock
{
    ...
    public class CarsControllerTests
    {
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentNullException))]
        public void AddingCarShouldThrowArgumentNullExceptionIfCarMakeIsEmpty()
        {
            var car = new Car
            {
                Id = 15,
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentNullException))]
        public void AddingCarShouldThrowArgumentNullExceptionIfCarModelIsEmpty()
        {
            var car = new Car
            {
                Id = 15,
        ...
        [TestMethod]
        public void SearchShouldWorkProperlyWithMake()
        {
        ...
        [TestMethod]
        public void SortByMakeShouldReturnACorrectlySortedCollection()
        {
        ...
        [TestMethod]
        public void SortByYearShouldReturnACorrectlySortedCollection()
        {
