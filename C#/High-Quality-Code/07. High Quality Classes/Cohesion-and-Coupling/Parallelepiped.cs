    ...
    public class Parallelepiped
    {
        ...
        public double Width
        {
            ...
            set
            {
                if (value <= 0)
                {
                    throw new ArgumentException("The width of the parallelepiped cannot be zero or negative!");
                }
        ...
        public double Height
        {
            ...
            set
            {
                if (value <= 0)
                {
                    throw new ArgumentException("The height of the parallelepiped cannot be zero or negative!");
                }
        ...
        public double Depth
        {
            ...
            set
            {
                if (value <= 0)
                {
                    throw new ArgumentException("The depth of the parallelepiped cannot be zero or negative!");
                }
